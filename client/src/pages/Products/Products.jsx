                ...
                <div className="flex gap-3 mt-2 sm:mt-2 sm:mx-3 m-auto ">
                    ...
                    <div className="flex-1 relative ">
                        ...
                        {!loading && products?.length === 0 && (
                            <div className="flex flex-col items-center justify-start gap-3 bg-white shadow-xl rounded-2xl p-6 sm:p-16 sm:min-h-[750px] border border-[#e6fbff]">
                                <img
                                    draggable="true"
                        ...
                        {loading ? (
                            ...
                            products?.length !== 0 && (
                                <div className="flex flex-col gap-2 pb-4 justify-center items-center w-full overflow-hidden bg-white rounded-2xl shadow-xl border border-[#e6fbff]">
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-4 w-full place-content-start overflow-hidden pb-4 min-h-[750px] bg-[#f7fafd] rounded-2xl">
