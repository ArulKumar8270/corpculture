...
const menuStructure = [
        ...
        subItems: [
            ...
            },
            {
                ...
                subItems: [
                    ...
                    { name: "Delivery Challan (DC Copy)", key: "serviceDeliveryChallan", permissions: ['view', 'add', 'edit', 'delete'] },
                    { name: "Returnable Challan", key: "serviceReturnableChallan", permissions: ['view', 'add', 'edit', 'delete'] },
            ...
            },
            {
                ...
                subItems: [
                    ...
                    { name: "Delivery Challan (DC Copy)", key: "rentalDeliveryChallan", permissions: ['view', 'add', 'edit', 'delete'] },
                    { name: "Returnable Challan", key: "rentalReturnableChallan", permissions: ['view', 'add', 'edit', 'delete'] },
            ...
            },
            {
                ...
                subItems: [
                    ...
                    { name: "Employee Benefits", key: "reportsEmployeeBenefits", permissions: ['view'] },
                    ...
                    { name: "Leave Report", key: "reportsLeaveReport", permissions: ['view'] },
                ]
            }
        ]
    },
    {
        ...
        subItems: [
            ...
            { name: "Payslip", key: "otherSettingsPayslip", permissions: ['view', 'add', 'edit', 'delete'] },
