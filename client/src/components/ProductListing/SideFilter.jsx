        ...
        <div className="hidden sm:flex flex-col w-1/5 px-1">
            <div className="flex flex-col bg-white rounded-2xl shadow-xl border border-[#e6fbff]">
                <div className="flex items-center justify-between gap-5 px-4 py-3 border-b rounded-t-2xl">
                    ...
                    <span
                        className="uppercase text-xs cursor-pointer font-semibold text-[#019ee3] hover:underline"
                ...
                <div className="flex flex-col gap-2 py-3 text-sm overflow-hidden">
                    ...
                    <div className="flex flex-col gap-2 border-b px-4">
                        ...
                        <div className="flex gap-3 items-center mb-2">
                            <span className="flex-1 min-w-[70px] border px-4 py-1 rounded-xl text-gray-800 bg-gray-50">
                    ...
                    <div className="flex flex-col border-b px-4">
                        ...
                        >
                            <p className="font-semibold text-xs uppercase text-[#afcb09]">
                                Category
                            </p>
                            {categoryToggle ? (
