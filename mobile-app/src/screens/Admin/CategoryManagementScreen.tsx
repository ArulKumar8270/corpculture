              ...
              {categories.length > rowsPerPage ? (
                <View style={styles.pagination}>
                  ...
                  <Text style={styles.pageInfo}>
                    Page {page + 1} of {Math.max(1, Math.ceil(categories.length / rowsPerPage))}
                  </Text>
                  <TouchableOpacity
                    style={[styles.pageBtn, page >= Math.ceil(categories.length / rowsPerPage) - 1 && styles.pageBtnDisabled]}
