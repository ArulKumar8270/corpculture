...
const ServiceInvoiceListScreen = () => {
  ...
  const onCancelInvoice = (invoice: any) => {
  ...
  const displayedInvoices = listTab === 'cancelled' ? cancelledInvoices : activeInvoices;
    ...
    return (
      <View style={styles.invoiceCard}>
        ...
        <View style={styles.actionButtons}>
          ...
          {hasPermission('serviceInvoice', 'edit') && invoiceType !== 'quotation' ? (
            <TouchableOpacity
              style={[styles.actionButton, styles.cancelButton]}
              onPress={() => onCancelInvoice(item)}
              ...
              <View style={styles.paginationContainer}>
                <View style={styles.paginationControls}>
                  ...
                  <Text style={styles.paginationText}>
                    Page {page + 1} of {Math.ceil(displayedInvoices.length / rowsPerPage) || 1}
                  </Text>
                  <TouchableOpacity
                    style={[
                      styles.paginationButton,
                      page >= Math.ceil(displayedInvoices.length / rowsPerPage) - 1 && styles.paginationButtonDisabled
                    ]}
                    onPress={() => handleChangePage(page + 1)}
                    disabled={page >= Math.ceil(displayedInvoices.length / rowsPerPage) - 1}
                  >
                    <Text
                      style={[
                        styles.paginationButtonText,
                        page >= Math.ceil(displayedInvoices.length / rowsPerPage) - 1 && styles.paginationButtonTextDisabled
                      ]}
                    >
                      Next
                    </Text>
