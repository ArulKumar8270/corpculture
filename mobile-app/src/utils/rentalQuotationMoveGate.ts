...
export function hasRentalInvoicePaymentDetails(entry: any) {
  return (
...
export function getRentalInvoiceStatusFlags(entry: any) {
  const isSent =
 ...
 */
export function getRentalInvoiceOverallReportStatus(entry: any) {
...
export function canMoveRentalInvoiceToOverallReport(entry: any) {
